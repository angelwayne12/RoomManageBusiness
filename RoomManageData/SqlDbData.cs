...
namespace RoomManageData
{
    public class SqlDbData
    {
        string connectionString
            = "Data Source =ELIJAH\\SQLEXPRESS; Initial Catalog = Room ; Integrated Security = True;";
        ...
        {
            string selectStatement = "SELECT Roomnum, Name FROM tblRoom";
        ...
        public int AddRoom(string Roomnum, string Name)
        {
            ...
            string insertStatement = "INSERT INTO tblRoom Values (@Roomnum, @Name)";
        ...
        public int UpdateRoom(string Roomnum, string Name)
        {
            ...
            string updateStatement = $"UPDATE tblRoom SET Name = @Name WHERE Roomnum = @Roomnum";
        ...
        public int DeleteRoom(string Roomnum)
        {
            ...
            string deleteStatement = $"DELETE FROM tblRoom WHERE Roomnum = @Roomnum";
